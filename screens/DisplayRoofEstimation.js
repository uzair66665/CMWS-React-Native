    ...
    <SafeAreaView style={style.container}>
      ...
      <Text style={style.Text}>Estimated Material</Text>
          ...
          <View style={{marginTop: 10}}>
            ...
            <Text style={style.label}>Steel Required :</Text>
            <Text style={style.label1}>{steel} Ton</Text>
