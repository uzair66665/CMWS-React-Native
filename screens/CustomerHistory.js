...
export default function CustomerHistory({navigation}) {
    ...
    const GetOrders =  async() => {
        ...
        await  fetch(global.ip+"cart/GetHistoryOrders", {
                method: 'POST',
                headers: {
            ...
            renderItem={({item})=>(
                ...
                <View style={style.orders}>
                    <View style={style.name}>
                        <Text style={style.txt}>{item.v_name}</Text>
                    </View>
                    <View style={style.name}>
                        <TouchableOpacity onPress={()=>navigation.navigate('CustomerHistoryDetails',{c_id:item.c_id})}>
