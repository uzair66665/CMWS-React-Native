...
export default function Plaster({navigation,route}) {
    ...
    const CheckEmpty = () => {
     ...
     var wetVolumeincft= ((+Length)*(+Height)*(+thicknessinfoot));
     ...
     navigation.navigate('DisplayPlaster',{CementTotalinBags,SandinCFT})
  ...
  return (
    ...
    <Text style={style.Text}>Plaster Estimation</Text>
    </View>
      ...
      <View style={{marginTop: '2%'}}>
        ...
        <View style={{marginTop: 10}}>
          ...
          <TextInput
            ...
            keyboardType='number-pad'
            value={Height}
            onChangeText={Height => Set_Height(Height)}
          />
        </View>
